use domichain_program::{msg, program_error::ProgramError};
...
impl<'a> Constraint<'a> for All<'a> {
    ...
    fn validate(
        ...
        rule_set_state_pda: &Option<&domichain_program::account_info::AccountInfo>,
        rule_authority: &Option<&domichain_program::account_info::AccountInfo>,
    ) -> RuleResult {
        msg!("Validating All");
