use domichain_program::{msg, program_error::ProgramError, pubkey::PUBKEY_BYTES};
...
impl<'a> Constraint<'a> for ProgramOwnedTree<'a> {
    ...
    fn validate(
        ...
        _rule_set_state_pda: &Option<&domichain_program::account_info::AccountInfo>,
        _rule_authority: &Option<&domichain_program::account_info::AccountInfo>,
    ) -> RuleResult {
